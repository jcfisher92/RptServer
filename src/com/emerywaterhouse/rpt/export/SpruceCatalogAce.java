...
public class SpruceCatalogAce extends Report
{
    ...
    *
    * @param ejdItemId The item to get the alternate UPC for.
    * @return The UPC
    *
    * @throws SQLException
    */
   private String getAltUpc(int ejdItemId) throws SQLException
   {
      String altUpc = " ";
      ResultSet rs = null;

      m_UpcData.setInt(1, ejdItemId);
      m_UpcData.setInt(2, m_Dc);
   ...
   private boolean prepareStatements()
   {
      ...
      if ( m_EdbConn != null ) {
         try {            
            sql.append("select ");            
            sql.append("item_entity_attr.item_ea_id ,item_entity_attr.item_id, ejd_item.ejd_item_id, ");
            ...
            sql.append("ejd_item_warehouse.cube, retail_unit.unit as uom, ejd_item.flc_id, mdc.mdc_id, mdc.nrha_id, ");
            ...
            sql.append("left outer join ejd_item_whs_upc on ejd_item_whs_upc.ejd_item_id = ejd_item.ejd_item_id and ejd_item_whs_upc.warehouse_id = warehouse.warehouse_id ");
            sql.append("      and primary_upc = 1 ");
            ...
            sql.append("   ejd_price_procs.get_retail_price(?, ?) as retail "); // cust id, item_ea_id
         ...
         log.error("[SpruceCatalogAce].prepareStatements - null oracle connection");
