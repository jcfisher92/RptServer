 ...
 *    table: emeryd.aptcpr.  Code is based on Paul Davidson's source code DaRemittance.java, which is based on
...
public class PositivePay extends Report 
{
