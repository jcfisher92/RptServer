...
public class POBackhaul extends Report {
   ...
   public boolean createReport()
   {
      ...
      try {
         ...
         log.fatal("[POBackhaul#createReport] ", ex);
      }
   ...
   private boolean prepareStatements() {
      ...
      if ( m_EdbConn != null ) {
         try {
            ...
            sql.append("FROM   EJD.PO_BACKHAUL_VIEW PO_BACKHAUL_VIEW ");            
            ...
            log.error("[POBackhaul#prepareStatements] ", ex);
         }
         finally {
            sql = null;
         }         
         ...
         log.error("[POBackhaul#prepareStatements] null oracle connection");
      }
   ...
   private boolean buildOutputFile() throws FileNotFoundException
   {
      ...
      m_FileNames.add(m_RptProc.getUid() + "_pobackhaul_" + getStartTime() + ".xlsx");
      ...
      try {
         ...
         log.fatal("[POBackhaul#buildOutputFile] ", ex);
      }
         ...
         try {
            ...
            log.error("[POBackhaul#buildOutputFile] " , e);
         }
   ...
   private void initReport()
   {
      ...
      try {
         ...
         createCell(m_Row, col++, date, m_StyleTitle);
         createCell(m_Row, col++, "Purchase Order Back Haul Report", m_StyleTitle);
         ...
         log.error("[POBackhaul#initReport] ", e );
      }
   }
